...
trigger_github_action "kontinuum-investments" "Website" "Citadel Deployment" "$github_branch" "$github_access_token"
trigger_github_action "kontinuum-investments" "Vita-API" "Citadel Deployment" "$github_branch" "$github_access_token"